...
- **OpenAI itself.** You can't test that Whisper transcribes correctly —
  that's their job. You test that you *call* it correctly and *handle*
...
5. **§1.4 Payment flow widget tests** (~9 tests, 2 hours) — *before* you
   actually go live on Play Store. These protect real money.
6. **§9 Backend infrastructure** (~9 tests, 2 hours)
7. **§7 Account lifecycle** (~5 tests, 1 hour) — *before* Play Store, GDPR
